...
if (isset($_POST['nome2']) && isset($_POST['email2']) && isset($_POST['telefone2'])){

$assunto = "Landing Page";

// pegando os dados do form...
$msg = "Nome: " . $_POST["nome2"] . "<br>";
$msg .= "E-mail: " . $_POST["email2"] . "<br>";
$msg .= "Telefone:<br>" . $_POST["telefone2"];
...
$headers .= "From: " . $_POST["nome2"] . "<" . $_POST["email2"] . ">\r\n";
$headers .= "Reply-To: " . $_POST["email2"] . "\r\n";
